...
| `dicoshot-spring-boot-3-starter` | Spring Boot 3.x 전용 auto-configuration |
| `dicoshot-spring-boot-4-starter` | Spring Boot 4.0+ 전용 auto-configuration |
...
**Gradle**
```gradle
implementation 'io.github.dicoshot:dicoshot-spring-boot-3-starter:0.2.0'
```
...
**Gradle**
```gradle
implementation 'io.github.dicoshot:dicoshot-spring-boot-4-starter:0.2.0'
```
...
<dependency>
    <groupId>io.github.dicoshot</groupId>
    <artifactId>dicoshot-spring-boot-4-starter</artifactId>
    <version>0.2.0</version>
</dependency>
```
...
./gradlew :dicoshot-spring-boot-3-starter:test
./gradlew :dicoshot-spring-boot-4-starter:test
```
